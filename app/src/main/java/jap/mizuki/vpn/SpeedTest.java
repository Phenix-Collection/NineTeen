...
import jap.mizuki.vpn.SpeedTestHandler.HttpDownloadTest;
import jap.mizuki.vpn.SpeedTestHandler.HttpUploadTest;
import jap.mizuki.vpn.SpeedTestHandler.PingTest;
import jap.mizuki.vpn.activity.AboutActivity;
import jap.mizuki.vpn.activity.BookmarkServerListActivity;
import jap.mizuki.vpn.activity.LoaderActivity;
import jap.mizuki.vpn.activity.MyPreferencesActivity;
import jap.mizuki.vpn.activity.ServerActivity;

import static jap.mizuki.vpn.activity.BaseActivity.connectedServer;
import static jap.mizuki.vpn.activity.BaseActivity.sendTouchButton;
